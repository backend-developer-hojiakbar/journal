...
class EditorialBoardMemberSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'journal', 'journal_name', 'journal_short_name', 'full_name', 'position_description', 'role', 'order']
...
class IssueSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'journal', 'journal_name', 'journal_short_name', 'journal_type', 'journal_type_display',
                  'title', 'cover_image', 'pdf_file', 'published_date', 'is_current', 'current_status_display', 'articles']
