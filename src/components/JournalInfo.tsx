      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-4 max-w-4xl mx-auto text-gray-600 space-y-3 text-lg">
            <p>
              Muassis: O‘zbekiston Respublikasi Qishloq xo'jaligi va Suv xo'jaligi vazirliklari
            </p>
            <p>
              Bosh muharrir: Tohir DOLIYEV
            </p>
            <p className="text-base mt-6">
              «O'zbekiston qishloq va suv xo'jaligi» jurnali 1906-yildan, «Agro ilm» jurnali esa 2007-yildan buyon chop etilib kelinmoqda. Jurnallar Qishloq xo‘jaligi va Suv xo‘jaligi vazirligi tizimidagi uyushma, birlashma, korxona va tashkilotlar, jumladan, oliy o‘quv yurtlari, ilmiy-tadqiqot muassasalari faoliyatini, iqtisodiy islohotlar samaralarini, shuningdek, ilmiy-tadqiqot ishlari, izlanish va yangiliklarini yoritib boradi.
            </p>
          ...
          <div className="border border-gray-300 rounded-lg overflow-hidden">
            {fanlar.map((fan, index) => (
              <div
                ...
                } ${index !== fanlar.length - 1 ? "border-b border-gray-300" : ""}`}
              >
